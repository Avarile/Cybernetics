...
describe('ContactsRmCommand', () => {
  ...
  const make = () => new ContactsRmCommand(settings, clients, confirmPrompt, isTTY);
  ...
  it('--yes deletes without prompting', async () => {
    ...
    expect(del).toHaveBeenCalledWith('/contacts/aaaaaaaa-1111-1111-1111-111111111111');
  });
