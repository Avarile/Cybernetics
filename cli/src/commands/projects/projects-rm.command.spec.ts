...
describe('ProjectsRmCommand', () => {
  ...
  const make = () => new ProjectsRmCommand(settings, clients, confirmPrompt, isTTY);
  ...
  it('--yes deletes without prompting', async () => {
    ...
    expect(del).toHaveBeenCalledWith('/projects/aaaaaaaa-1111-1111-1111-111111111111');
  });
